...
/*Уменьшение шапки меню*/
$(document).scroll(function() {
	if($(document).scrollTop()>200)
	{
		/*Шапка маленькая*/
		$(".header-t").css('padding','1px 0 1px 15px');
				$(".header-0").css('background','#333');
	...
	if($(document).scrollTop()<=200)
	{
		...
		$(".header-0").css('background','rgba(7,7,7,0.3)');
		$("#logo").attr('src','images/asus-logo.png');
	}
})
/*    /Уменьшение шапки меню*/
...
var videoA = function () 
{this.innerHTML = '<video width="100%" src="images/ASUS-ZenBook-3-product-video854.mp4"  controls autoplay>'}; 

document.querySelector('.video-center').addEventListener('click', function (e) 
{ this.removeEventListener('click', videoA, false); videoA.apply(this, arguments);} , false);
